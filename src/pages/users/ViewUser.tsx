...
import { getUserDetailsService } from "../../services/agrofusion/auth.service";
...
const ViewUser = () => {
  ...
  const deleteUser = async () => {
    try {
      setLoading(true);
      await getUserDetailsService(userId || "")
  ...
  return (
    <AppLayoutSB>
      ...
      {!loading && !error && userDetails && (
        ...
        <div className="p-4 py-10 mt-2 font-semibold border rounded-2xl">
        ...
        <div className="flex justify-end gap-3 mt-3">
            ...
            <Button onClick={()=> deleteUser()} color="red" >{t("viewUser.deleteUser")}</Button>
